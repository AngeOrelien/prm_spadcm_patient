...
/// Police unique de l'app Patients/Familles — branchée via `google_fonts`.
///
/// ┌──────────────────────────────────────────────────────────────────────┐
/// │  UN SEUL ENDROIT À MODIFIER POUR CHANGER LA POLICE DE TOUTE L'APP.   │
/// │  Remplace `GoogleFonts.ubuntuSans` par ex. par `GoogleFonts.poppins` │
/// │  dans les deux méthodes ci-dessous, et relance l'app : tous les      │
/// │  écrans (textTheme, AppTextStyles, boutons, champs...) suivent.      │
/// └──────────────────────────────────────────────────────────────────────┘
///
/// `google_fonts` est déjà déclaré dans `pubspec.yaml` (aucune dépendance
