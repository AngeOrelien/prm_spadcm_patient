...
/// RDV, évolution IA, notation de l'AVS (UC5/UC6/UC7), Messages — AVS
/// affecté, médecins, coordonnateurs, administrateurs (UC8), Profil —
/// compte, famille, sécurité (UC12).
///
/// Le bouton SOS flottant a été retiré (UC4) : "Signaler une urgence" vit
/// désormais dans l'onglet Messages (voir `messagerie_page.dart`), au même
/// endroit que le reste des échanges avec l'équipe SPAD Cameroun, plutôt
/// que sur un bouton flottant séparé.
